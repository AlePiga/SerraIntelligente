...
// Costruttore
ImpiantoAlpino::ImpiantoAlpino(int id, const string& nome) : Impianto(id, nome) {}

void ImpiantoAlpino::aggiorna(const Orario& orarioAttuale, const Orario& orarioPrecedente) {
...
string ImpiantoAlpino::getTipo() const {
    return "Alpino";
}